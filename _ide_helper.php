 ...
 * Generated for Laravel 5.4.36 on 2018-10-30 06:56:31.
 *
...
namespace ShaoZeMing\LaravelTranslate\Facade { 
    ...
    class Translate {
        ...
        {
            return \ShaoZeMing\Translate\TranslateService::setDriver($driver);
        }
        ...
        {
            return \ShaoZeMing\Translate\TranslateService::setFromAndTo($from, $to);
        }
         ...
         * @static 
         */ 
        public static function setHttpOption($options = array())
        {
            return \ShaoZeMing\Translate\TranslateService::setHttpOption($options);
        }
        ...
        {
            return \ShaoZeMing\Translate\TranslateService::translate($string, $source);
        }
